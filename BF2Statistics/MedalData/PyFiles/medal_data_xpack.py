medal_data = (
	...
	('1261119_1', 'X1Acb', 1, object_stat('kits', 'kills', KIT_TYPE_ASSAULT, 6)),#stop
	('1261119_2', 'X1Acb', 1, f_and(has_medal('1261119_1'), global_stat('ktm-1', 57600), object_stat('kits', 'kills', KIT_TYPE_ASSAULT, 22))),#stop
	('1261119_3', 'X1Acb', 1, f_and(has_medal('1261119_2'), global_stat('ktm-1', 360000), object_stat('kits', 'kills', KIT_TYPE_ASSAULT, 44))),#stop
	('1261120_1', 'X1Atcb', 1, object_stat('kits', 'kills', KIT_TYPE_AT, 11)),#stop
	('1261120_2', 'X1Atcb', 1, f_and(has_medal('1261120_1'), global_stat('ktm-0', 57600), object_stat('kits', 'kills', KIT_TYPE_AT, 22))),#stop
	('1261120_3', 'X1Atcb', 1, f_and(has_medal('1261120_2'), global_stat('ktm-0', 360000), object_stat('kits', 'kills', KIT_TYPE_AT, 44))),#stop
	('1261109_1', 'X1Sncb', 1, object_stat('kits', 'kills', KIT_TYPE_SNIPER, 11)),#stop
	('1261109_2', 'X1Sncb', 1, f_and(has_medal('1261109_1'), global_stat('ktm-6', 57600), object_stat('kits', 'kills', KIT_TYPE_SNIPER, 17))),#stop
	('1261109_3', 'X1Sncb', 1, f_and(has_medal('1261109_2'), global_stat('ktm-6', 360000), object_stat('kits', 'kills', KIT_TYPE_SNIPER, 38))),#stop
	('1261115_1', 'X1Socb', 1, object_stat('kits', 'kills', KIT_TYPE_SPECOPS, 6)),#stop
	('1261115_2', 'X1Socb', 1, f_and(has_medal('1261115_1'), global_stat('ktm-4', 57600), object_stat('kits', 'kills', KIT_TYPE_SPECOPS, 22))),#stop
	('1261115_3', 'X1Socb', 1, f_and(has_medal('1261115_2'), global_stat('ktm-4', 360000), object_stat('kits', 'kills', KIT_TYPE_SPECOPS, 44))),#stop
	('1261121_1', 'X1Sucb', 1, object_stat('kits', 'kills', KIT_TYPE_SUPPORT, 11)),#stop
	('1261121_2', 'X1Sucb', 1, f_and(has_medal('1261121_1'), global_stat('ktm-5', 57600), object_stat('kits', 'kills', KIT_TYPE_SUPPORT, 22))),#stop
	('1261121_3', 'X1Sucb', 1, f_and(has_medal('1261121_2'), global_stat('ktm-5', 360000), object_stat('kits', 'kills', KIT_TYPE_SUPPORT, 44))),#stop
	('1261105_1', 'X1Ecb', 1, object_stat('kits', 'kills', KIT_TYPE_ENGINEER, 11)),#stop
	('1261105_2', 'X1Ecb', 1, f_and(has_medal('1261105_1'), global_stat('ktm-2', 57600), object_stat('kits', 'kills', KIT_TYPE_ENGINEER, 22))),#stop
	('1261105_3', 'X1Ecb', 1, f_and(has_medal('1261105_2'), global_stat('ktm-2', 360000), object_stat('kits', 'kills', KIT_TYPE_ENGINEER, 44))),#stop
	('1261113_1', 'X1Mcb', 1, object_stat('kits', 'kills', KIT_TYPE_MEDIC, 11)),#stop
	('1261113_2', 'X1Mcb', 1, f_and(has_medal('1261113_1'), global_stat('ktm-3', 57600), object_stat('kits', 'kills', KIT_TYPE_MEDIC, 22))),#stop
	('1261113_3', 'X1Mcb', 1, f_and(has_medal('1261113_2'), global_stat('ktm-3', 360000), object_stat('kits', 'kills', KIT_TYPE_MEDIC, 44))),#stop
	('1260602_1', 'X1fbb', 1, object_stat ('weapons', 'deployed', WEAPON_TYPE_TACTICAL, 10)),#stop
	('1260602_2', 'X1fbb', 1, f_and(has_medal ('1260602_1'),f_plus(global_stat ('de-6'),object_stat ('weapons', 'deployed', WEAPON_TYPE_TACTICAL),100))),#stop
	('1260602_3', 'X1fbb', 1, f_and(has_medal ('1260602_2'),f_plus(global_stat ('de-6'),object_stat ('weapons', 'deployed', WEAPON_TYPE_TACTICAL),500))),#stop
	('1260708_1', 'X1ghb', 1, object_stat ('weapons', 'deployed', WEAPON_TYPE_GRAPPLINGHOOK, 10)),#stop
	('1260708_2', 'X1ghb', 1, f_and(has_medal ('1260708_1'),f_plus(global_stat ('de-7'),object_stat ('weapons', 'deployed', WEAPON_TYPE_GRAPPLINGHOOK),100))),#stop
	('1260708_3', 'X1ghb', 1, f_and(has_medal ('1260708_2'),f_plus(global_stat ('de-7'),object_stat ('weapons', 'deployed', WEAPON_TYPE_GRAPPLINGHOOK),500))),#stop
	('1262612_1', 'X1zlb', 1, object_stat ('weapons', 'deployed', WEAPON_TYPE_ZIPLINE, 10)),#stop
	('1262612_2', 'X1zlb', 1, f_and(has_medal ('1262612_1'),f_plus(global_stat ('de-8'),object_stat ('weapons', 'deployed', WEAPON_TYPE_ZIPLINE),100))),#stop
	('1262612_3', 'X1zlb', 1, f_and(has_medal ('1262612_2'),f_plus(global_stat ('de-8'),object_stat ('weapons', 'deployed', WEAPON_TYPE_ZIPLINE),500))),#stop
	...
	('3260318', 'X1Csr', 1, f_and(player_stat('driverSpecials', 1), player_stat('driverAssists', 20), player_stat('kills', 10))),#stop
	('3260118', 'X1Arr', 1, f_and(object_stat('vehicles', 'rtime', VEHICLE_TYPE_ARMOR, 1200), object_stat('vehicles', 'kills', VEHICLE_TYPE_ARMOR, 22))),#stop
	('3260105', 'X1Aer', 1, f_and(object_stat('vehicles', 'rtime', VEHICLE_TYPE_AVIATOR, 900), object_stat('vehicles', 'kills', VEHICLE_TYPE_AVIATOR, 22))),#stop
	('3260803', 'X1Hsr', 1, f_and(object_stat('vehicles', 'rtime', VEHICLE_TYPE_HELICOPTER, 900), object_stat('vehicles', 'kills', VEHICLE_TYPE_HELICOPTER, 22))),#stop
)
