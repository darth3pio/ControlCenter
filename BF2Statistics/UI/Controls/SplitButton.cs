...
namespace BF2Statistics
{
    ...
    /// 
    /// </summary>
    /// <seealso cref="http://wyday.com/splitbutton/"/>
    public class SplitButton : Button
    {
        ...
        /// <summary>
        /// Allows the splitline to always be displayed, not just on hover
        /// </summary>
        /// <remarks>
        /// Added by: Steven Wilson
        /// </remarks>
        [DefaultValue(false), Browsable(true), Category("Appearance")]
        [Description("If set to true, the Split line will be displayed as long as there is a ContextMenu assigned to this control")]
        public bool ShowSplitlineAlways
        {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            bool drawSplitLine = ((showSplit && ShowSplitlineAlways) || State == PushButtonState.Hot || State == PushButtonState.Pressed || !Application.RenderWithVisualStyles);
